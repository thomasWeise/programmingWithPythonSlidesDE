...
%
\only<-2>{%
\item \ruff\ ist ein \python\ \glslink{linter}{Linter} der Kode nach Stilinkonsistenzen, möglichen Fehlern, und möglichen Verbesserungen durchsucht\cite{PC2024PL}%
}%
...
%
\item<3-> Sie würden dann \bashil{pip install pylint}\pythonIdx{pip} eintippen und \keys{\enter}~drücken.%
%
...
\end{itemize}%
%
\locateGraphic{2-5}{width=0.65\paperwidth}{graphics/pipInstallPylint}{0.175}{0.544}%
\end{frame}%
%
\begin{frame}%
...
\listingPythonAndOutput{9}{loops:for_loop_no_enumerate_2}{}{0.2}{0.4}{0.6}{0.59}%
%
\end{frame}%
%
