...
\begin{itemize}%
\item \pythonilIdx{int}: der Datentyp für die ganzen Zahlen~\integerNumbers\uncover<3->{,}%
...
\item<8-> \python~3 hat nur einen einzigen Datentyp für die Ganzzahlen:~\pythonilIdx{int}.%
...
\item<49-> die Fließkommadivison~\pythonil{/} liefert Ergebnisse, die keine \pythonil{int}-Werte mehr sind und Kommastellen haben\cite{PEP238}.\uncover<49->{ Wir lernen den Datentyp \pythonil{float} später kennen.}%
\end{enumerate}%
}%
%
\end{itemize}%
...
\item<7-> Und wieder sind wir einen Schritt weiter.%
\item<8-> Wenn es Sie interessiert, können Sie sich den Appendix über verschiedene Zahlensysteme und bit-basierte Operatoren anschauen.%
\end{itemize}%
\end{frame}%
%
\endPresentation%
%
\section{Appendix für Interessierte}%
%
\begin{frame}[t]%
