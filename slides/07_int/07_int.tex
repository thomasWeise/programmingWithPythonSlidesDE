...
\item<48-> die Fließkommadivison~\pythonil{/} liefert Ergebnisse, die keine \pythonil{int}-Werte mehr sind und Kommastellen haben\cite{PEP238}.\uncover<49->{ Wir lernen den Datentyp \pythonil{float} später kennen.}%
\end{enumerate}%
}%
%
\end{itemize}%
