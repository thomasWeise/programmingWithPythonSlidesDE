...
\item<4-> Wir haben eine Aufgabe zu erledigen, irgendeine Sache.%
...
\frametitle{Programmieren}%
\begin{itemize}%
\item In der überwältigenden Mehrheit der Fälle erstellen wir ein Programm \emph{nicht}, um es nur ein einziges Mal auszuführen.%
...
\uncover<7->{%
\begin{enumerate}%
\item Vielleicht fragen Sie sich, ob Sie einen Fehler gemacht haben.\uncover<8->{ Leute machen Fehler.\uncover<9->{ Je schwieriger die Aufgabe ist, die wir lösen wollen, je mehr Programmkode wir schreiben, desto wahrscheinlicher ist es, dass wir irgendwo irgendeinen Fehler machen.\uncover<10->{ \alert<10>{Also müssen Sie Ihre Programme \glslink{unitTest}{testen}.}}}}%
...
\begin{itemize}%
\item Für diesen Kurs reicht unser Kursbuch\cite{programmingWithPython}.%
\item Weitere Bücher zu \glslink{unitTest}{Softwaretests} und \glslink{continuousIntegration}{kontinuierliche Integration}:\begin{itemize}%
