...
%
\only<-32>{%
\item<30-> Objekte bekommen dabei den Wert \pythonil{True}, \alert{\textbf{es sei denn}}, sie bieten selber eine explizite Umrechnung in den Typ \pythonil{bool} an (und die ergibt \pythonil{False}) oder sie haben eine Länge (und die ist~0).%
}
%
\only<-32>{%
