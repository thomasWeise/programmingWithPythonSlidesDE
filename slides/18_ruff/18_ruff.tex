...
%
\item<4-> Schauen wir uns das Programm \textil{lists_error.py} an.%
%
...
\begin{itemize}%
\only<-2>{%
\item Wenden wir \ruff\ auf das Programm \textil{lists_error.py} an.%
}%
%
\only<-3>{%
...
%
\begin{itemize}%
\item Lösen wir also alle drei entdeckten Probleme und erstellen ein Programm \textil{lists_fixed.py}.%
