...
%
\only<-30>{\item<29-> Wir testen, ob $6>5$ gilt.\uncover<30->{ Ja, tut es.}}%
%
\only<-32>{\item<32-> Wir testen, ob $6\geq5$ gilt.\uncover<32->{ Ja, tut es.}}%
%
\only<-34>{\item<33-> Wir testen, ob $6==5$ gilt.\uncover<34->{ Nein, tut es nicht.}}%
%
\only<-36>{\item<35-> Wir testen, ob $6\leq5$ gilt.\uncover<36->{ Nein, tut es nicht.}}%
%
...
%
\only<-46>{\item<45-> Wir testen, ob $5.0==5$ gilt.\uncover<46->{ Ja, tut es.}}%
%
