...
%
\only<-36>{%
\item<33-> Das ist genau die gleiche Bedingung, mit der wir unsere neue \pythonil{sqrt} Implementierung, die selber Ausnahmen auslöst, in \programUrl{exceptions:test_sqrt_raise_2} getestet hatten.%
}%
%
\only<-37>{%
