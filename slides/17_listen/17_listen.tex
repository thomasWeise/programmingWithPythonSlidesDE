...
%
\item<5-> \python\ bietet uns vier Arten von Kollektionen:~Listen~\inEN{lists}, Tupel~\inEN{tuples}, Mengen~\inEN{sets}, und Dictionaries.%
%
...
\frametitle{Listen}%
\begin{itemize}%
\item Listen sind \emph{veränderbare}~\inEN{mutable} Sequenzen von Objekten.%
...
\listingOutput{10-}{lists:lists_1}{}{0.395}{0.2}{0.58}{0.8}%
%
\end{frame}%
%
\begin{frame}[t]%
...
\listingOutput{10-}{lists:lists_2}{}{0.395}{0.2}{0.58}{0.8}%
%
\end{frame}%
%
\begin{frame}[t]%
...
\listingOutput{7-}{lists:lists_3}{}{0.395}{0.2}{0.8}{0.8}%
%
\end{frame}%
%
