...
\item<7-> Für \python\ empfehlen wir die \pycharm\cite{VHN2023HOADWP,Y2022PPADT,W2024PME} \pgls{ide}, die kostenlos ist.%
...
\item<4-> Dann schreiben wir das Kommando \bashil{sudo snap install pycharm --classic} und drücken~\keys{\return}.}%
...
\only<-3>{\item<3-> Wir klicken auf \menu{.exe (Windows)} um den \pycharm-Download zu starten.}%
...
\only<-6>{\item<6-> Nach dem der Download abgeschlossen ist, führen wir das heruntergeladene Programm aus -- \DEzB\ durch Klick auf \menu{Open file}.}%
...
\only<-15>{\item<15-> Die Installation ist abgeschlossen. Wir wählen \inQuotes{Run PyCharm} aus und klickeb \menu{Finish}.}%
