...
\item<2-> Sie können ein Terminal\cite{B2022ELATCL} durch Druck auf~\ubuntuTerminal\ öffnen.\uncover<3->{ Schreiben Sie dann \bashil{python3 --version} und drücken Sie \keys{\return}, um die installierte Versionsnummer angezeigt zu bekommen.}%
\end{itemize}%
%
