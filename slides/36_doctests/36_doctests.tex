...
%
\item<2-> Wenn wir darüber nachdenken, erkennen wir, dass \pglspl{unitTest} auch Teil der Dokumentation von Software sind.%
%
...
%
\only<-23>{%
\item<9-> Normalerweise würden wir jetzt Kode bereitstellen, der \pythonil{flatten} ausführt und ihre Ausgabe präsntiert.%
}%
%
\only<-24>{%
