...
%
\item<7-> Natürlich können wir genauso gut den \python-Interpreter im normalen Terminal öffnen und die Befehle Zeile für Zeile dort eintippen.%
\end{enumerate}%
}
...
\item<6-> Natürlich werden wir unsere Programme in \inQuotes{richtigen} Projekten immer in Dateien speichern.%
\item<7-> Aber zum Kennenlernen von \python\ ist eine interaktive Nutzung des Interpreters sehr geeignet\cite{PSF:P3D:TPT:AIITP}.%
\end{itemize}%
\end{frame}%
%
\endPresentation%
