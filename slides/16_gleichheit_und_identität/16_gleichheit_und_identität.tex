...
%
\item<4-> Am nächsten Tag kaufen Sie eine gleiche grüne Jacke. Wie nennen sie~$B$.%
%
...
\multicolumn{2}{c}{\includegraphics[width=0.275\paperwidth]{graphics/different}}&%
\multicolumn{2}{c}{\uncover<2->{\includegraphics[width=0.275\paperwidth]{graphics/equal}}}&%
\multicolumn{2}{c}{\uncover<4->{\includegraphics[width=0.275\paperwidth]{graphics/same}}}\\%
%
