...
\uncover<7->{%
\begin{enumerate}%
\item Vielleicht fragen Sie sich, ob Sie einen Fehler gemacht haben.\uncover<8->{ Leute machen Fahler.\uncover<9->{ Je schwieriger die Aufgabe ist, die wir lösen wollen, je mehr Programmkode wir schreiben, desto wahrscheinlicher ist es, dass wir irgendwo irgendeinen Fehler machen.\uncover<10->{ \alert<10>{Also müssen Sie Ihre Programme testen.}}}}%
...
\uncover<3->{ Nach der jährlichen Stack Overflow Umfrage 2024\cite{SESO:DWMMMT2RFSOADS}, war \python\ die zweitpopulärste Programmiersprache nach \pgls{javascript} and \glslink{HTML}{HTML}/CSS.%
...
\uncover<10->{ Darum war \python\ auch die populärste Programmiersprache für Leute, die das Programmieren lernen wollen, nach der oben erwähnten Umfrage~\cite{SESO:DWMMMT2RFSOADS}.}}}%
\end{enumerate}%
%
